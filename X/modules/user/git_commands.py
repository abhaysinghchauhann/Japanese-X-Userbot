...
# @Client.on_message(filters.command(["lastcommit", "lc"], ".") & filters.me)
# async def last_commit(bot: Client, message: Message):
#     repo = Repository(os.getcwd())
#     master = repo.head.reference
#     commit = master.commit.message.strip()
#     commit_id = master.commit.hexsha
#     commit_link = f"<a href='https://github.com/Japanese-Userbots/Japanese-X-Userbot/commit/{commit_id}'>{commit_id[:7]}</a>"
